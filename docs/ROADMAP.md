...
| Tablet, landscape, split-screen, and external-keyboard workflows | `Partial` | `Partial` | Android adapts terminal system-bar handling for multi-window and visible desktop caption bars; both platforms still need their full device and interaction matrices. |
